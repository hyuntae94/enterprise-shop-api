"""initial schema: users, products, orders, order_items, payments

Revision ID: 0001_initial
Revises:
Create Date: 2026-06-01

Hand-authored initial migration. Subsequent migrations should be generated
with ``alembic revision --autogenerate -m "..."`` once a database is available.
"""
